...
import HomeDice from '../components/home-dice';
...
export default function DiceRushHome() {
  ...
  const handleHostGame = async () => {
    try {
      ...
      router.push('/lobby?gameId=dice-rush');
    } catch (error) {
      logger.error('DiceRushHome', 'Failed to create room', error);
  ...
  const handleJoinGame = async () => {
    ...
    try {
      ...
      logger.error('DiceRushHome', 'Exception during join', error);
